...
func NewHelpView(deps Deps) *HelpView {
	items := []components.ListItem{
		...
		{Title: "enter / space", Description: deps.T("Select item / open folder"), Tag: "Key"},
		{Title: "l / →", Description: deps.T("Descend into folder (also in delete mode)"), Tag: "Key"},
		{Title: "esc", Description: deps.T("Go back / cancel operation"), Tag: "Key"},
		{Title: "/", Description: deps.T("Filter items"), Tag: "Key"},
		{Title: "r", Description: deps.T("Refresh current view"), Tag: "Key"},
		{Title: "p", Description: deps.T("Toggle object metadata preview"), Tag: "Key"},
		{Title: "P", Description: deps.T("Generate presigned URL"), Tag: "Key"},
